...
@section('content')
    <section class="content-header">
        ...
        <h1 class="pull-right">
            ...
            <a class="btn btn-success pull-right flat" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('pathans.create') !!}">{{ __('field.next') }} <i class="fa fa-forward" aria-hidden="true"></i></a>
